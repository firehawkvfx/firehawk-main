...
source "amazon-ebs" "amazonlinux2-ami" {
  ...
  ami_name        = "firehawk-vault-client-amazonlinux2-${local.timestamp}-{{uuid}}"
...
source "amazon-ebs" "centos7-ami" {
  ...
  ami_name        = "firehawk-vault-client-centos7-${local.timestamp}-{{uuid}}"
  instance_type   = "t2.micro"
  region          = "${var.aws_region}"
...
source "amazon-ebs" "ubuntu16-ami" {
  ...
  ami_name        = "firehawk-vault-client-ubuntu16-${local.timestamp}-{{uuid}}"
  instance_type   = "t2.micro"
  region          = "${var.aws_region}"
...
source "amazon-ebs" "ubuntu18-ami" {
  ...
  ami_name        = "firehawk-vault-client-ubuntu18-${local.timestamp}-{{uuid}}"
  instance_type   = "t2.micro"
  region          = "${var.aws_region}"
...
build {
  sources = ["source.amazon-ebs.amazonlinux2-ami", "source.amazon-ebs.centos7-ami", "source.amazon-ebs.ubuntu18-ami"]
  ...
  provisioner "shell" {
    ...
    only = ["amazon-ebs.amazonlinux2-ami"]
  }
  provisioner "shell" {
    inline = [
    ...
    only = ["amazon-ebs.amazonlinux2-ami", "amazon-ebs.centos7-ami"]
  }
  ...
  provisioner "shell" {
    ...
    only   = ["amazon-ebs.ubuntu16-ami", "amazon-ebs.amazonlinux2-ami", "amazon-ebs.centos7-ami"]
  }
  provisioner "shell" {
    inline = [
