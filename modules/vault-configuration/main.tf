...
resource "vault_aws_auth_backend_role" "provisioner" {
  ...
  bound_iam_role_arns             = concat( var.vault_client_role_arns, [ module.vault_client_iam.vault_client_role_arn ]) # Only instances with this Role ARN May read vault data.
